# Capability: CRM Kanban Pipeline
- **key**: `crm_pipeline`
- **category**: crm
- **origin portal**: MARTECH
## What to implement
Companies/contacts/deals/notes/tasks Kanban with lead capture, scoring, and analytics.
## How to apply
...
<!-- federated-by: MARTECH master | v1 | 2026-08-09T20:30:55.891Z -->
