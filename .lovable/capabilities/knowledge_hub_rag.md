# Capability: Knowledge Hub RAG
- **key**: `knowledge_hub_rag`
- **category**: ai
- **origin portal**: MARTECH
## What to implement
pgvector knowledge base with resilient embeddings for retrieval-augmented answers and WhatsApp semantic search.
## How to apply
...
<!-- federated-by: MARTECH master | v1 | 2026-08-09T20:31:13.567Z -->
