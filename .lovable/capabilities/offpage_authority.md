# Capability: Off-Page Authority Engine
- **key**: `offpage_authority`
- **category**: seo
- **origin portal**: MARTECH
## What to implement
Automates off-codebase ranking signals (backlinks, competitor gap, Wikipedia footprint, forum/directory mentions) with AI prioritisation and Make dispatch.
## How to apply
