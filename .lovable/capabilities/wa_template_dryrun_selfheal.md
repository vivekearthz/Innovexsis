# Capability: WhatsApp Template Dry-Run Self-Heal
- **key**: `wa_template_dryrun_selfheal`
- **category**: whatsapp
- **origin portal**: MARTECH
## What to implement
Sends every approved template to a test number with classify->remediate->retry loopback (param_mismatch/header_missing/bad_language/transient).
## How to apply
...
<!-- federated-by: MARTECH master | v1 | 2026-08-09T20:31:08.787Z -->
